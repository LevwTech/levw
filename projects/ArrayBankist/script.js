...
// selector.innerHTML is similar to textContent but returns the entire html of the selector
// template string literals work great with html
// insert html in selector using:   selector.insertAdjacentHtml('place', html)
// html here is a variable of string u want to insert :D
// place can be : 
...
// filter is same as map but return condition

// const x = [1,2,-1,-2];
// const y = x.filter(item => item >0);
// console.log(y);
